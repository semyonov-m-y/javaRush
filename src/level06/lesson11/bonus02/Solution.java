...
public class Solution
{
    ...
    public static class Cat
    {
        ...
        public String toString()
        {
            ...
            else if (parentW == null&&parentM!=null)
                return "Cat name is " + name + ", no mother, father is " + parentM.name;
            else if (parentM == null&&parentW!=null)
                return "Cat name is " + name + ", mother is " + parentW.name + ", no father";
            else
                return "Cat name is " + name + ", mother is " + parentW.name + ", father is " + parentM.name;
        }
    }
